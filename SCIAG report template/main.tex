...
\usepackage{latexsym}
\usepackage{array}
\usepackage[bookmarks, colorlinks=true, pdfborder={0 0 0}, pdftitle={ARTICLE TITLE}, pdfauthor={ARTICLE AUTHOR}, pdfsubject={ARTICLE SUBJECT}, pdfkeywords={ARTICLE KEYWORDS}]{hyperref}
\linespread{1}
\usepackage{titlesec}
...
\fancyfoot[LE,LO]{\textit {\raisebox{-7pt}{\includegraphics[scale=0.02]{logo/sciag.jpeg}} Report PROJECT NAME - CLASS CODE - AUTHOR} } \fancyfoot[RE,RO]{\bfseries\thepage}
...
\input{introduction}
\newpage
\input{exploratory_data_analysis}
\newpage
\input{method}
\newpage
\input{results}
